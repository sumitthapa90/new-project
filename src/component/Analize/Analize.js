    ...
    <div className="analize w-full mx-auto py-16 px-4 bg-white ">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <h3 className="sm:text-3xl  md:text-2xl lg:text-2xl xl:text-2xl text-2xl text-black mt-5 font-mono">
          ...
          <button className="w-[300px] bg-orange-600 rounded-md p-2 hover:bg-sky-700 mt-5 font-mono">
            Get Started
          </button>
