    ...
    <div className="w-full py-16 text-white bg-stone-700 px-4 ">
      <div className="max-w-[1240px] mx-auto grid lg:grid-cols-3">
        <div className="lg:col-span-2">
          <h2 className="md:text-4xl sm:text-3xl text-2xl py-2 font-bold text-white font-mono">
            Want tips and tricks to optimise the form
          </h2>
          <p className="font-mono">Sing up to the newsLetter and Stay up to date</p>
        </div>
        ...
        <div className="my-4">
          <div className="flex flex-col sm:flex-row items-center justify-between w-full mb-3">
            ...
            <button className="w-[200px] bg-orange-600 rounded-md p-3  hover:bg-sky-700  ml-4 font-mono">
              Notify Me
            </button>
          </div>
          <p children="font-mono">
