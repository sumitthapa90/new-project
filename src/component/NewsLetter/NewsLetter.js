      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        <div className="flex flex-col justify-center item-cnter ">
          <div className="">
            ...
            <h4 className="sm:text-3xl  md:text-2xl lg:text-2xl xl:text-2xl text-2xl  mt-5 font-mono">
          ...
          <div>
            <h4 className="sm:text-3xl  md:text-2xl lg:text-2xl xl:text-2xl text-2xl font-mono mt-5">
