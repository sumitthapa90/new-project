...
function Hero() {
  ...
  return (
    <div className="hero text-white text-center">
      <div className="max-w-[800]  w-full h-screen mx-auto flex flex-col justify-center ">
        ...
        <div>
          ...
          <p className="texed max-w-[800] sm:text-2xl r md:text-3xl lg:text-2xl xl:text-2xl mb-4 text-xl">
            <Typed
              className="type text-2xl"
              strings={[
        ...
        <button className="w-[200px] bg-orange-600 rounded-md p-2 mx-auto hover:bg-sky-700 font-mono">
          Get Started
        </button>
      </div>
    </div>
